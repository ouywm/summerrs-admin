...
pub fn expand(args: TokenStream, input: TokenStream) -> TokenStream {
    ...
    let ok_status_arm = if ok_is_response {
        quote! {
            Ok(Ok(resp)) => (
                model::entity::sys_operation_log::OperationStatus::Success,
                None::<String>,
        ...
        quote! {
            Ok(Err(e)) => {
                let __log_response_code = match e {
                    common::error::ApiErrors::BadRequest(_) => 400i16,
                    common::error::ApiErrors::Unauthorized(_) => 401i16,
                    common::error::ApiErrors::Forbidden(_) => 403i16,
                    common::error::ApiErrors::NotFound(_) => 404i16,
                    common::error::ApiErrors::Conflict(_) => 409i16,
                    common::error::ApiErrors::IncompleteUpload(_) => 409i16,
                    common::error::ApiErrors::ValidationFailed(_) => 422i16,
                    common::error::ApiErrors::TooManyRequests(_) => 429i16,
                    common::error::ApiErrors::Internal(_) => 500i16,
                    common::error::ApiErrors::ServiceUnavailable(_) => 503i16,
                };
                (
                    model::entity::sys_operation_log::OperationStatus::Failed,
                    Some(format!("{:#}", e)),
                    __log_response_code,
                )
            },
