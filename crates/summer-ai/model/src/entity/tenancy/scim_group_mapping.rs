//! AI SCIM 组映射表
//! 对应 sql/ai/scim_group_mapping.sql
...
#[repr(i16)]
pub enum ScimGroupMappingStatus {
    /// 正常
    #[sea_orm(num_value = 1)]
    Normal = 1,
    /// 停用
...
#[sea_orm(schema_name = "ai", table_name = "scim_group_mapping")]
pub struct Model {
    /// 组映射ID
    #[sea_orm(primary_key)]
    pub id: i64,
    ...
    /// 目标范围类型：organization/team/project
    ...
    /// 状态：1=正常 2=停用 3=待删除
    pub status: ScimGroupMappingStatus,
    /// 最近一次 SCIM 载荷（JSON）
