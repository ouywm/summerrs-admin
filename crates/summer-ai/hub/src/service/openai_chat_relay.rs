...
use crate::service::openai_http::{
    extract_request_id, extract_upstream_request_id, insert_request_id_header,
    insert_upstream_request_id_header,
};
use crate::service::openai_tracking::{
    FailureTrackingUpdate, RequestTrackingIds, record_terminal_failure,
