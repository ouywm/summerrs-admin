...
use crate::service::openai_relay_support::{
    BufferedMultipartField, buffer_multipart_fields, build_image_edit_form,
    build_image_variation_form, parse_image_edit_meta, parse_image_variation_meta,
};
...
pub struct OpenAiImageMultipartRelayService {
    #[inject(component)]
...
impl OpenAiImageMultipartRelayService {
    pub async fn relay_edits(
        &self,
