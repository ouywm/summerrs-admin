...
mod tests {
    ...
    use crate::sql_rewrite::{
        extensions::Extensions, plugin::SqlRewritePlugin, registry::PluginRegistry,
    };
    ...
    impl SqlRewritePlugin for CommentPlugin {
        ...
        fn matches(&self, _ctx: &crate::sql_rewrite::context::SqlRewriteContext) -> bool {
            true
        }

        fn rewrite(
            &self,
            ctx: &mut crate::sql_rewrite::context::SqlRewriteContext,
        ) -> crate::sql_rewrite::Result<()> {
        ...
        fn rewrite(
            ...
            select.selection = Some(Expr::BinaryOp {
                left: Box::new(Expr::BinaryOp {
                    ...
                    right: Box::new(crate::sql_rewrite::helpers::build_bound_placeholder(2)),
                }),
                op: BinaryOperator::And,
                right: Box::new(Expr::BinaryOp {
                    left: Box::new(Expr::Identifier(sqlparser::ast::Ident::new("name"))),
                    op: BinaryOperator::Eq,
                    right: Box::new(crate::sql_rewrite::helpers::build_bound_placeholder(1)),
                }),
            });
            Ok(())
        }
